"""
Prompts and Pydantic response models for the two-step Wikidata knowledge
extraction and refinement pipeline.
...
Step 2 — **Refinement**: prompt that provides candidate canonical mappings
          and asks the LLM to select the best match from each top-5 list.
"""
...
# Three in-context examples (inspired by Wiki-cIE / Wikidata-style facts).
# They are baked into a single ChatMessages template; the user text is
# appended via Jinja ``{{ text }}`` variable at render time.
...
EXTRACTION_FEW_SHOT_EXAMPLES: list[tuple[str, str]] = [
    ...
    (
        ...
        '{"triplets": ['
        '{"subject": "Tahiti Honey", "relation": "director", "object": "John H. Auer"}, '
        '{"subject": "Tahiti Honey", "relation": "screenwriter", "object": "Lillie Hayward"}, '
        '{"subject": "Tahiti Honey", "relation": "publication date", "object": "1943"}'
        "]}"
    ),
    # Example 2
    (
        ...
        '{"triplets": ['
        '{"subject": "Marie Curie", "relation": "country of citizenship", "object": "Poland"}, '
        '{"subject": "Marie Curie", "relation": "country of citizenship", "object": "France"}, '
        '{"subject": "Marie Curie", "relation": "occupation", "object": "physicist"}, '
        '{"subject": "Marie Curie", "relation": "occupation", "object": "chemist"}, '
        '{"subject": "Marie Curie", "relation": "award received", "object": "Nobel Prize"}'
        "]}"
    ),
    # Example 3
    (
        ...
        '{"triplets": ['
        '{"subject": "Eiffel Tower", "relation": "location", "object": "Paris"}, '
        '{"subject": "Eiffel Tower", "relation": "country", "object": "France"}, '
        '{"subject": "Eiffel Tower", "relation": "designer", "object": "Gustave Eiffel"}, '
        '{"subject": "Eiffel Tower", "relation": "inception", "object": "1889"}'
        "]}"
    ),
]
...
REFINEMENT_SYSTEM_PROMPT = (
    "You are a knowledge-graph entity and relation linking algorithm.  "
    "You are given:\n"
    "  1. An original text.\n"
    "  2. A list of extracted triplets.\n"
    "  3. For every subject, relation and object of each triplet — a list "
    "of 5 canonical candidate names retrieved from Wikidata.\n\n"
...
def build_refinement_messages(
    ...
    lines.append("Triplets and corresponding entity and relation mappings:")
    ...
    for i, t in enumerate(triplets, 1):
        ...
        lines.append(f"Subject mapping: {{\"{t.subject}\": {s_cands}}}")
        lines.append(f"Relation mapping: {{\"{t.relation}\": {r_cands}}}")
        lines.append(f"Object mapping: {{\"{t.object}\": {o_cands}}}")
